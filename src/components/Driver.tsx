...
export const DriverModule = () => {
  ...
  const renderScreen = () => {
    switch(screen) {
      case 'dashboard': return <DriverDashboard setScreen={setScreen} setShowRequest={setShowRequest} />;
      ...
      default: return <DriverDashboard setScreen={setScreen} setShowRequest={setShowRequest} />;
    }
  };
...
const DriverDashboard = ({ setScreen, setShowRequest }: any) => {
